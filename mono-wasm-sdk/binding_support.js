var BindingSupportLib = {
  ...
  $BINDING: {
    ...
    bindings_lazy_init: function() {
      ...
      this.mono_array_to_heap = Module.cwrap(
        "mono_wasm_array_to_heap",
        "void",
        ["number", "number"]
      );
  ...
  mono_wasm_invoke_js_with_args: function(
    js_handle,
    method_name,
    args,
    is_exception
  ...
  mono_wasm_get_object_property: function(
    js_handle,
    property_name,
    is_exception
  ) {
  ...
  mono_wasm_set_object_property: function(
    js_handle,
    property_name,
    value,
    createIfNotExist,
